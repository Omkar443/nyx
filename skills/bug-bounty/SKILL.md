...
**Gate question:** Is an AI agent (Gemini CLI, NYX Agent, Cline, Codex) invoked in a workflow where external users can influence the prompt?
...
## Operator Notes (NYX Security Intelligence Engine)
