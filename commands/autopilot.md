...
**Start a fresh NYX AI Code session per target.** NYX AI accumulates context across a session —
...
For long hunts, run `/compact` (NYX AI Code built-in) periodically to compress context
