...
- No changes to NYX AI-OSINT.
- No NYX AI Code hooks; capture is engine code.
...
**Untouched:** `engine/state.py`, `pyproject.toml` (script-invoked, no packaging change), NYX AI-OSINT.
