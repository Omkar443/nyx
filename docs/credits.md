...
NYX Security Intelligence Engine is **the author's bug-hunting stack**, with a vendored foundation layer from upstream community work. Full attribution below.
...
Burp Suite Pro/Community is the foundation HTTP intercept tool. Their BApp Store includes an "MCP Server" extension that exposes Burp's proxy history to NYX AI Code via the Model Context Protocol.

**Burp Suite**: https://portswigger.net/burp
**MCP Server extension**: install via Burp's BApp Store

### Anthropic — NYX AI Code, Skills, MCP

The platform itself.

**NYX AI Code**: https://claude.ai/download
