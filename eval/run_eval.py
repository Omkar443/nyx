#!/usr/bin/env python3
"""
run_eval.py — v0 autonomous-hunt-loop eval harness for NYX Security Intelligence Engine.

Measures whether the hunt-* skills let a headless NYX AI Code agent autonomously
...
Execution engine: `claude -p` (headless NYX AI Code) — skills auto-activate; the
