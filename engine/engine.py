...
CLASS_WEIGHT = {"rce": 100, "sqli": 90, "ssrf": 85, "auth-bypass": 85, "idor": 80,
                ...
                "info-leak": 30}
# OSINT (subdomain/asset enum) is a SEPARATE concern (NYX AI-OSINT) — not in the engine flow.
...
class Engine:
    ...
    def _expand_scope(self):
        ...
        a separate concern (NYX AI-OSINT); this just ingests its result when you want one tool to do
